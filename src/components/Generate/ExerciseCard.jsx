    ...
    <div className='p-4 rounded-md flex flex-col gap-4 bg-black sm:flex-wrap'>
        <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
            ...
            text-indigo-400'>
                ...
                <p className='text-sm text-indigo-400 capitalize'>{exercise.type}</p>
        </div>
        <div className='flex flex-col'>
            <h3 className='text-indigo-400 text-sm'>Muscle Groups</h3>
            <p className='capitalize'>{exercise.muscles.join(' & ')}</p>
        </div>
        <div className='flex flex-col bg-black rounded gap-2'>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-indigo-900 hover:border-indigo-600 w-full'>
